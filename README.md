...
<p align="center">
  <b>Студент РТУ МИРЭА · начинающий разработчик · Python / FastAPI / PostgreSQL</b><br>
  Делаю веб-сервисы, разбираюсь в серверной логике, базах данных, тестировании, автоматизации и системное администрирование Linux.
</p>
...
Я студент первого курса **РТУ МИРЭА** и начинающий IT-специалист из Москвы. Программированием занимаюсь давно: начинал с небольших сайтов и Python-приложений, а потом постепенно пришёл к серверной разработке, базам данных, авторизации, тестам, Docker и развёртыванию.

Мой главный фокус сейчас – научиться работать с реальными системами: понимать архитектуру, данные, пользовательские сценарии, ошибки, ограничения и поддержку проекта после запуска.
...
Для меня это не просто учебный пример. В Saturn я учился собирать проект как систему: продумывать структуру, связывать сервер, базу данных и интерфейс, чинить ошибки, писать документацию и доводить запуск до понятного состояния.
...
### 2024–2026 · самостоятельная разработка

Сейчас я собираю портфолио уже более системно: репозитории, README, запуск через Docker, миграции, тесты, проверка через GitHub Actions и понятная структура проекта.
...
<table>
  ...
  <tr>
    ...
    <td>HTML, CSS, JavaScript, адаптивная вёрстка</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><b>Качество</b></td>
    <td>pytest, чек-листы, проверка пользовательских сценариев, разбор ошибок</td>
  </tr>
  <tr>
...
- развиваю **Saturn** и привожу проект к более понятной архитектуре;
- прокачиваю Python, базы данных, тестирование и инфраструктуру;
- ищу первую IT-роль, стажировку или техническую позицию, где можно быстро включиться в реальные задачи;
- учусь объяснять свои проекты не как “я что-то написал”, а как полноценные системы с пользователями, данными и ограничениями.
