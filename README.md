...
<p align="center">
  <b>Студент РТУ МИРЭА · начинающий разработчик · Python / Linux / PostgreSQL</b><br>
...
Я студент первого курса **РТУ МИРЭА** и начинающий разработчик из Москвы. Программированием занимаюсь давно: начинал с небольших сайтов и Python-приложений, а потом постепенно пришёл к серверной разработке, базам данных, авторизации, тестам, Docker и развёртыванию.
...
Сейчас я собираю портфолио уже более системно: репозитории, README, запуск через Docker, миграции, тесты и понятная структура проекта.
