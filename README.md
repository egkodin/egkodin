...
<p align="center">
  <b>Разработчик / Python / Linux / PostgreSQL</b><br>
...
Программированием занимаюсь давно: начинал с небольших сайтов и Python-приложений, а потом постепенно пришёл к серверной разработке, базам данных, авторизации, тестам, Docker и развёртыванию.
