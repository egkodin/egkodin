...
Сейчас расширяю опыт за пределы веб-разработки: изучаю Rust и создаю нативные desktop-приложения.
...
### 🎵 [Taglet](https://github.com/egkodin/taglet)
...
<p>
  <a href="https://github.com/egkodin/taglet">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=egkodin&repo=taglet&theme=default&hide_border=true" alt="Taglet repository card">
  </a>
</p>
...
| **[Taglet](https://github.com/egkodin/taglet)** | Rust, eframe/egui, ID3v2, локальная обработка MP3, безопасное сохранение | показывает развитие в нативной desktop-разработке и работе с файлами |
